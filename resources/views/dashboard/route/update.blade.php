        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" method="post" action="{{route('manage_route.update',$route->id)}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-10">
                                    <select name="to" id="select2-3" class="form-control">
                                        @foreach($cities as $c)
                                            <option
                                                    @if($c->name == $route->to)
                                                    selected
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xl-6 col-10">
                                    <select name="type" id="select2-3" class="form-control">
                                        ...
                                        <option
                                                @if( 'Locomotive' == $route->type)
                                                selected
                                                @endif
                                                value="Locomotive">Locomotive
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-xl-10">
                                    <input class="form-control" type="number" value="{{$route->price}}" name="price" required>
                                </div>
                            </div>
